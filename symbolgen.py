...
for i in range(0,rxnnum,1):
       ...
       entriesc.append(Checkbutton(root4, text="Reaction {} Reversable".format(i+1), variable=intvars[i]).grid(column=6, row=int(i), sticky=(N,E)))
...
class symbolgen:
       ...
       def gen(names, inits, eqs, intz):
              ...
              return Cs, reacts, prods, equats, slat, dlat
